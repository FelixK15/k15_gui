	...
	kg_u8 p_GlyphRangeFlags)
{
	...
	for (; glyphRangeIndex < glyphRangeArraySize;
		++glyphRangeIndex)
	{
	...
	kg_byte* p_DestinationPixel, K15_GUIPixelFormat p_DestinationPixelFormat)
{
	...
	{
		kg_s32 colorIndex = 0;
		for (; colorIndex < p_DestinationPixelFormat;
			++colorIndex)
		{
	...
	K15_GUIMouseInput* p_MouseEvents, kg_u16* p_MousePosInOutX, kg_u16* p_MousePosInOutY)
{
	...
	for (; eventIndex < p_NumMouseEvents;
		++eventIndex)
	{
	...
	K15_GUISystemEvent* p_SystemEvents)
{
	...
	for (; eventIndex < p_NumSystemEvents;
		++eventIndex)
	{ 
	...
	kg_color32 p_TextColor, kg_u16 p_VerticalPadding, kg_u16 p_HorizontalPadding)
{
		...
		++textIndex)
	{
		...
		for (; glyphRangeIndex < numGlyphRanges;
			++glyphRangeIndex)
		{
			glyphRange = glyphRanges + glyphRangeIndex;
