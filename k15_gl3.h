...
void K15_GL3RegisterGLFunctions()
{
	K15_GL3_CHECK_ASSIGNMENT(kglGetStringi, kwglGetProcAddress("glGetStringi"));
	K15_GL3_CHECK_ASSIGNMENT(kglCreateShader, kwglGetProcAddress("glCreateShader"));
	K15_GL3_CHECK_ASSIGNMENT(kglShaderSource, kwglGetProcAddress("glShaderSource"));
	K15_GL3_CHECK_ASSIGNMENT(kglCompileShader, kwglGetProcAddress("glCompileShader"));
	K15_GL3_CHECK_ASSIGNMENT(kglCreateProgram, kwglGetProcAddress("glCreateProgram"));
	K15_GL3_CHECK_ASSIGNMENT(kglGetShaderiv, kwglGetProcAddress("glGetShaderiv"));
	K15_GL3_CHECK_ASSIGNMENT(kglAttachShader, kwglGetProcAddress("glAttachShader"));
	K15_GL3_CHECK_ASSIGNMENT(kglLinkProgram, kwglGetProcAddress("glLinkProgram"));
	K15_GL3_CHECK_ASSIGNMENT(kglUseProgram, kwglGetProcAddress("glUseProgram"));
	K15_GL3_CHECK_ASSIGNMENT(kglDetachShader, kwglGetProcAddress("glDetachShader"));
	K15_GL3_CHECK_ASSIGNMENT(kglGetShaderInfoLog, kwglGetProcAddress("glGetShaderInfoLog"));
	K15_GL3_CHECK_ASSIGNMENT(kglGenBuffers, kwglGetProcAddress("glGenBuffers"));
	K15_GL3_CHECK_ASSIGNMENT(kglVertexAttribPointer, kwglGetProcAddress("glVertexAttribPointer"));
	K15_GL3_CHECK_ASSIGNMENT(kglEnableVertexAttribArray, kwglGetProcAddress("glEnableVertexAttribArray"));
	K15_GL3_CHECK_ASSIGNMENT(kglDisableVertexAttribArray, kwglGetProcAddress("glDisableVertexAttribArray"));
	K15_GL3_CHECK_ASSIGNMENT(kglDrawElementsBaseVertex, kwglGetProcAddress("glDrawElementsBaseVertex"));
	K15_GL3_CHECK_ASSIGNMENT(kglBindBuffer, kwglGetProcAddress("glBindBuffer"));
	K15_GL3_CHECK_ASSIGNMENT(kglBufferData, kwglGetProcAddress("glBufferData"));
	K15_GL3_CHECK_ASSIGNMENT(kglBufferSubData, kwglGetProcAddress("glBufferSubData"));
	K15_GL3_CHECK_ASSIGNMENT(kglDeleteBuffers, kwglGetProcAddress("glDeleteBuffers"));
	K15_GL3_CHECK_ASSIGNMENT(kglGetProgramiv, kwglGetProcAddress("glGetProgramiv"));
	K15_GL3_CHECK_ASSIGNMENT(kglDeleteProgram, kwglGetProcAddress("glDeleteProgram"));
	K15_GL3_CHECK_ASSIGNMENT(kglGetActiveUniform, kwglGetProcAddress("glGetActiveUniform"));
	K15_GL3_CHECK_ASSIGNMENT(kglGetActiveAttrib, kwglGetProcAddress("glGetActiveAttrib"));
	K15_GL3_CHECK_ASSIGNMENT(kglGetUniformLocation, kwglGetProcAddress("glGetUniformLocation"));
	K15_GL3_CHECK_ASSIGNMENT(kglGetAttribLocation, kwglGetProcAddress("glGetAttribLocation"));
	K15_GL3_CHECK_ASSIGNMENT(kglBlendEquationSeparate, kwglGetProcAddress("glBlendEquationSeparate"));
	K15_GL3_CHECK_ASSIGNMENT(kglBindFragDataLocation, kwglGetProcAddress("glBindFragDataLocation"));
	K15_GL3_CHECK_ASSIGNMENT(kglGetProgramInfoLog, kwglGetProcAddress("glGetProgramInfoLog"));
	K15_GL3_CHECK_ASSIGNMENT(kglBlendFuncSeparate, kwglGetProcAddress("glBlendFuncSeparate"));
	K15_GL3_CHECK_ASSIGNMENT(kglGenFramebuffers, kwglGetProcAddress("glGenFramebuffers"));
	K15_GL3_CHECK_ASSIGNMENT(kglBindFramebuffer, kwglGetProcAddress("glBindFramebuffer"));
	K15_GL3_CHECK_ASSIGNMENT(kglDeleteFramebuffers, kwglGetProcAddress("glDeleteFramebuffers"));
	K15_GL3_CHECK_ASSIGNMENT(kglGenRenderbuffers, kwglGetProcAddress("glGenRenderbuffers"));
	K15_GL3_CHECK_ASSIGNMENT(kglBindRenderbuffer, kwglGetProcAddress("glBindRenderbuffer"));
	K15_GL3_CHECK_ASSIGNMENT(kglDeleteRenderbuffers, kwglGetProcAddress("glDeleteRenderbuffers"));
	K15_GL3_CHECK_ASSIGNMENT(kglRenderbufferStorage, kwglGetProcAddress("glRenderbufferStorage"));
	K15_GL3_CHECK_ASSIGNMENT(kglFramebufferRenderbuffer, kwglGetProcAddress("glFramebufferRenderbuffer"));
	K15_GL3_CHECK_ASSIGNMENT(kglFramebufferTexture, kwglGetProcAddress("glFramebufferTexture"));
	K15_GL3_CHECK_ASSIGNMENT(kglCheckFramebufferStatus, kwglGetProcAddress("glCheckFramebufferStatus"));
	K15_GL3_CHECK_ASSIGNMENT(kglRenderbufferStorageMultisample, kwglGetProcAddress("glRenderbufferStorageMultisample"));
	K15_GL3_CHECK_ASSIGNMENT(kglTexImage3D, kwglGetProcAddress("glTexImage3D"));
	K15_GL3_CHECK_ASSIGNMENT(kglCompressedTexImage1D, kwglGetProcAddress("glCompressedTexImage1D"));
	K15_GL3_CHECK_ASSIGNMENT(kglCompressedTexImage2D, kwglGetProcAddress("glCompressedTexImage2D"));
	K15_GL3_CHECK_ASSIGNMENT(kglCompressedTexImage3D, kwglGetProcAddress("glCompressedTexImage3D"));
	K15_GL3_CHECK_ASSIGNMENT(kglGenerateMipmap, kwglGetProcAddress("glGenerateMipmap"));
	K15_GL3_CHECK_ASSIGNMENT(kglActiveTexture, kwglGetProcAddress("glActiveTexture"));
	K15_GL3_CHECK_ASSIGNMENT(kglDebugMessageCallback, kwglGetProcAddress("glDebugMessageCallbackARB"));
	K15_GL3_CHECK_ASSIGNMENT(kglGenVertexArrays, kwglGetProcAddress("glGenVertexArrays"));
	K15_GL3_CHECK_ASSIGNMENT(kglBindVertexArray, kwglGetProcAddress("glBindVertexArray"));
	K15_GL3_CHECK_ASSIGNMENT(kglDeleteVertexArrays, kwglGetProcAddress("glDeleteVertexArrays"));
